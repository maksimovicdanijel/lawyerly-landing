...
export const Hero = () => {
  return (
    <section
      className="w-screen h-screen flex justify-center items-center mb-[28vw] md:mb-[18vw] lg:mb-[10vw] xl:mb-[13vw] 2xl:mb-60 pb-24 sm:pb-32 md:pb-44 lg:pb-0"
      id="home"
    >
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex flex-col pt-16 md:pt-16 lg:pt-20">
        ...
        >
          <div className="text-7xl font-bold drop-shadow-sm text-center tracking-tight text-indigo-950">
